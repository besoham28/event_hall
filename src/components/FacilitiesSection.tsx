...
const facilities = [
  ...
  { icon: Car, title: "Valet Parking", desc: "Stress-free arrival for your guests with our expansive parking facility for 200+ vehicles, managed by a professional and courteous valet team." },
  ...
  { icon: BedDouble, title: "Luxury Guest Rooms", desc: "15 opulent guest suites featuring premium linens, modern attached bathrooms, and traditional aesthetic touches for your family's comfort." },
  ...
  return (
    <section id="facilities" ref={sectionRef} className="section-padding bg-muted">
      <div className="container mx-auto text-center">
        ...
        <div className="facility-grid grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
          {facilities.map((f) => (
            <div key={f.title} className="facility-card card-premium p-8 text-left group">
        ...
        <div className="technical-content mt-12 py-12 border-t border-gold/20">
          <div className="grid lg:grid-cols-2 gap-10 items-stretch text-left">
            <div className="bg-white/40 backdrop-blur-md p-8 md:p-10 border border-gold/20 rounded-lg shadow-sm">
              <p className="section-subtitle mb-3">Specifications</p>
              <h2 className="section-title mb-6">Technical Excellence</h2>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                {[
                  ...
                  { label: "Kitchen Area", value: "3,500 Sq. Ft." },
                  ...
                  <div key={spec.label} className="border-l-2 border-gold pl-4 py-2">
            ...
            <div className="bg-royal p-8 md:p-12 relative overflow-hidden group">
              {/* Decorative background flare */}
              <div className="absolute top-0 right-0 w-32 h-32 bg-gold/10 blur-3xl rounded-full -mr-16 -mt-16 group-hover:bg-gold/20 transition-all duration-700" />
              
              <h3 className="font-display text-2xl font-bold text-gold mb-6">Facility Quick Facts</h3>
              <ul className="space-y-4">
                {[
                  ...
                  "High-speed industrial Wi-Fi connectivity",
                ].map((fact, i) => (
                  <li key={i} className="flex items-start gap-3">
                    <div className="mt-1.5 w-1.5 h-1.5 rounded-full bg-gold shrink-0" />
                    <p className="text-cream/80 font-body text-sm leading-tight">
                      {fact}
                    </p>
                  </li>
                ))}
